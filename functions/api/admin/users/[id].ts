...
interface UserRow {
  id: string
  role: 'super_admin' | 'admin' | 'volunteer' | 'reader'
  status: string
}
 ...
 * revoke outright), and only a volunteer can hold it — a reader never
 * downloads regardless, and an admin/super_admin already can.
 */
